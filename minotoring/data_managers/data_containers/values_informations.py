...
class ValuesInformations:
    ...
    def get_dict(self):
        return {"training": self.training.get_dict(), "prediction": self.prediction.get_dict(), "id2phase": {**{id: "training" for id in self.training.ids }, **{id: "prediction" for id in self.prediction.ids }}}
